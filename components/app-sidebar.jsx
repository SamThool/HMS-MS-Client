...
const navByTeam = {
  ...
  DIAGNOSIS: [
    {
      title: "Test Orders",
      url: "/diagnosis/orders",
      icon: ClipboardList,
    },
    {
      title: "Reports",
      url: "/diagnosis/reports",
      icon: FileText,
    },
  ],

  MASTER: [
    { title: "Prefixes", url: "/master/refs/prefixes", icon: Hash },
    { title: "Hospital", url: "/master/catalog/hospitals", icon: Hospital },
    { title: "Department", url: "/master/org/department", icon: Building },
    {
